...
Requires **Python 3.13+** and a reachable Redis. Nothing is on PyPI yet, so
install from source — clone this repo alongside your `tai-skeleton` checkout and
add it as an editable dependency of the environment that runs the server:
